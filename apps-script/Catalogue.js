 ...
 * d'illustration libre — le coach peut en ajouter une par fiche.
 *
...
const CATALOGUE_DEPART = [
  ...
  // ── Poids de corps et street workout ─────────────────────
  // Vocabulaire courant de la discipline : ces noms n'appartiennent à personne.
  ["Muscle-up", "Dos", "Poids de corps", "Muscle Up",
   "Traction explosive suivie d'un passage au-dessus de la barre. Demande déjà une dizaine de tractions strictes.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Muscle_Up/0.jpg"],
  ["Traction australienne", "Dos", "Poids de corps", "Inverted Row",
   "Barre à hauteur de hanches, corps gainé en planche. Plus la barre est basse, plus c'est dur.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Inverted_Row/0.jpg"],
  ["Traction prise neutre", "Dos", "Poids de corps", "",
   "Paumes face à face sur une barre en V. La plus douce des trois prises pour l'épaule.",
   ""],
  ["Traction lestée", "Dos", "Poids de corps", "",
   "Ceinture de lest ou haltère entre les pieds. À aborder une fois dix tractions strictes acquises.",
   ""],
  ["Traction tempo", "Dos", "Poids de corps", "",
   "Montée normale, descente de trois à cinq secondes. Le moyen le plus simple de durcir sans lest.",
   ""],
  ["Négatives de traction", "Dos", "Poids de corps", "",
   "Départ menton au-dessus de la barre, descente la plus lente possible. Étape avant la première traction.",
   ""],
  ["Pompes en équilibre", "Épaules", "Poids de corps", "Handstand Push-Ups",
   "Dos au mur, mains un peu plus larges que les épaules. Descendre jusqu'à frôler le sol du crâne.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Handstand_Push-Ups/0.jpg"],
  ["Pompes piquées", "Épaules", "Poids de corps", "",
   "Bassin haut, corps en V inversé. La version accessible des pompes en équilibre.",
   ""],
  ["Pompes déclinées", "Pectoraux", "Poids de corps", "Decline Push-Up",
   "Pieds surélevés : le haut des pectoraux et les épaules prennent davantage.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Decline_Push-Up/0.jpg"],
  ["Pompes inclinées", "Pectoraux", "Poids de corps", "Incline Push-Up",
   "Mains surélevées : la version allégée, pour construire les premières répétitions.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Incline_Push-Up/0.jpg"],
  ["Pompes archer", "Pectoraux", "Poids de corps", "",
   "Un bras plié, l'autre tendu sur le côté. Étape vers la pompe à un bras.",
   ""],
  ["Pompes à un bras", "Pectoraux", "Poids de corps", "",
   "Pieds écartés pour l'équilibre, hanches face au sol. Le gainage compte autant que la force.",
   ""],
  ["Pompes sautées", "Pectoraux", "Poids de corps", "",
   "Poussée explosive, mains décollées. Travail de puissance, séries courtes.",
   ""],
  ["Dips aux barres parallèles", "Triceps", "Poids de corps", "Dips - Triceps Version",
   "Buste vertical, épaules basses. Descendre jusqu'à l'angle droit au coude, pas plus bas.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Dips_-_Triceps_Version/0.jpg"],
  ["L-sit", "Abdominaux", "Poids de corps", "",
   "Suspendu ou en appui, jambes tendues à l'horizontale. Chronométré, pas compté.",
   ""],
  ["Front lever", "Dos", "Poids de corps", "",
   "Corps horizontal sous la barre, bras tendus. Progression : groupé, une jambe, jambes tendues.",
   ""],
  ["Back lever", "Dos", "Poids de corps", "",
   "Corps horizontal face au sol, bras tendus derrière. Attention aux coudes, échauffer longuement.",
   ""],
  ["Planche gymnique", "Épaules", "Poids de corps", "",
   "Corps horizontal en appui sur les mains, pieds décollés. Des années de pratique, pas des semaines.",
   ""],
  ["Hollow body", "Abdominaux", "Poids de corps", "",
   "Dos plaqué au sol, épaules et jambes décollées. La position de base de toute la gymnastique.",
   ""],
  ["Superman au sol", "Lombaires", "Poids de corps", "Superman",
   "Sur le ventre, bras et jambes décollés. Tenir sans bloquer la respiration.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Superman/0.jpg"],
  ["Dragon flag", "Abdominaux", "Poids de corps", "",
   "Corps rigide qui descend depuis les épaules, mains accrochées derrière la tête. Très exigeant.",
   ""],
  ["Relevé de jambes à la barre", "Abdominaux", "Poids de corps", "Hanging Leg Raise",
   "Jambes tendues jusqu'à l'horizontale ou plus haut, sans balancier.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Hanging_Leg_Raise/0.jpg"],
  ["Essuie-glace", "Abdominaux", "Poids de corps", "",
   "Suspendu, jambes qui balaient d'un côté à l'autre. Après le relevé de jambes strict.",
   ""],
  ["Squat pistolet", "Jambes", "Poids de corps", "",
   "Sur une jambe, l'autre tendue devant. Se travaille d'abord sur une boîte, en descendant s'asseoir.",
   ""],
  ["Squat sauté", "Jambes", "Poids de corps", "Freehand Jump Squat",
   "Descente contrôlée, poussée explosive. Amortir en pliant les genoux.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Freehand_Jump_Squat/0.jpg"],
  ["Fentes sautées", "Jambes", "Poids de corps", "",
   "Changement de jambe en l'air. Genou arrière proche du sol à la réception.",
   ""],
  ["Leg curl nordique", "Jambes", "Poids de corps", "",
   "À genoux, chevilles bloquées, descente lente vers l'avant. Redoutable pour les ischios.",
   ""],
  ["Chaise au mur", "Jambes", "Poids de corps", "",
   "Dos au mur, cuisses à l'horizontale. Exercice au temps, pas en répétitions.",
   ""],
  ["Montées de genoux", "Jambes", "Poids de corps", "",
   "Course sur place, genoux à hauteur de bassin. Échauffement ou cardio.",
   ""],
  ["Grimpeur", "Abdominaux", "Poids de corps", "Mountain Climbers",
   "En planche, genoux qui viennent alternativement vers la poitrine. Bassin stable.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Mountain_Climbers/0.jpg"],
  ["Burpee", "Jambes", "Poids de corps", "",
   "Squat, planche, pompe, saut. Le tout-en-un du travail sans matériel.",
   ""],
  ["Saut groupé", "Jambes", "Poids de corps", "Knee Tuck Jump",
   "Saut vertical, genoux ramenés à la poitrine. Réception amortie.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Knee_Tuck_Jump/0.jpg"],
  ["Saut sur boîte", "Jambes", "Poids de corps", "Front Box Jump",
   "Monter en sautant, redescendre en marchant. Ne jamais enchaîner les descentes sautées.",
   "https://raw.githubusercontent.com/yuhonas/free-exercise-db/main/exercises/Front_Box_Jump/0.jpg"],
  ["Gainage bras tendus", "Abdominaux", "Poids de corps", "",
   "Planche sur les mains plutôt que les avant-bras. Épaules au-dessus des poignets.",
   ""],
  ["Gainage dynamique", "Abdominaux", "Poids de corps", "",
   "Passage alternatif des avant-bras aux mains, sans bouger le bassin.",
   ""],
  ["Pont fessier au sol", "Fessiers", "Poids de corps", "",
   "Pieds au sol, montée du bassin jusqu'à l'alignement. La base avant le hip thrust lesté.",
   ""],

  // ── Progressions : suspensions, negatives, assistances, explosif ──
  ["Suspension passive", "Dos", "Poids de corps", "",
   "Simplement pendu à la barre, épaules relâchées. Prépare le grip et décomprime les épaules.",
   ""],
  ["Suspension active", "Dos", "Poids de corps", "",
   "Pendu bras tendus, on descend les épaules en éloignant les oreilles. Le premier degré de la traction.",
   ""],
  ["Suspension horizontale active", "Dos", "Poids de corps", "",
   "Sous une barre basse, corps gainé, épaules basses et serrées. Version horizontale de la suspension active.",
   ""],
  ["Support actif aux dips", "Triceps", "Poids de corps", "",
   "Bras tendus sur les barres, épaules poussées vers le bas. Se tenir avant de descendre.",
   ""],
  ["Support actif en pompes", "Pectoraux", "Poids de corps", "",
   "Position haute de pompe tenue, omoplates écartées, corps aligné. Chronométré.",
   ""],
  ["Support actif en pompes piquées", "Épaules", "Poids de corps", "",
   "Position haute des pompes piquées tenue, bassin haut. Prépare l'équilibre.",
   ""],
  ["Tractions d'omoplates", "Dos", "Poids de corps", "",
   "Bras tendus, seul le mouvement d'omoplates fait monter le corps de quelques centimètres.",
   ""],
  ["Dips d'omoplates", "Triceps", "Poids de corps", "",
   "Bras tendus sur les barres, on monte et descend par les seules épaules.",
   ""],
  ["Rows d'omoplates", "Dos", "Poids de corps", "",
   "Sous la barre basse, bras tendus, on serre les omoplates sans plier les coudes.",
   ""],
  ["Pompes d'omoplates", "Pectoraux", "Poids de corps", "",
   "En position de pompe bras tendus, on écarte puis serre les omoplates. Le buste monte et descend seul.",
   ""],
  ["Négatives de dips", "Triceps", "Poids de corps", "",
   "Départ bras tendus, descente en trois à cinq secondes, remontée avec les pieds au sol.",
   ""],
  ["Négatives de pompes", "Pectoraux", "Poids de corps", "",
   "Descente très lente, remontée sur les genoux. Étape avant la pompe complète.",
   ""],
  ["Tractions explosives", "Dos", "Poids de corps", "",
   "Traction menée assez vite pour que la barre quitte les mains ou arrive au sternum. Vers le muscle-up.",
   ""],
  ["Dips explosifs", "Triceps", "Poids de corps", "",
   "Poussée assez forte pour décoller les mains des barres. Réception amortie.",
   ""],
  ["Tractions avec élastique", "Dos", "Poids de corps", "",
   "Élastique sous les pieds ou les genoux : l'assistance est maximale en bas, là où c'est le plus dur.",
   ""],
  ["Dips avec élastique", "Triceps", "Poids de corps", "",
   "Élastique passé sous les genoux entre les barres. Permet de tenir des séries complètes.",
   ""],
  ["Rowing horizontal pronation", "Dos", "Poids de corps", "",
   "Sous une barre basse, paumes vers l'avant. Plus de dos et d'arrière d'épaules.",
   ""],
  ["Rowing horizontal supination", "Dos", "Poids de corps", "",
   "Sous une barre basse, paumes vers soi. Les biceps participent davantage.",
   ""],
  ["Rowing horizontal à un bras", "Dos", "Poids de corps", "",
   "Un seul bras sous la barre, l'autre le long du corps. Le buste résiste à la rotation.",
   ""],
  ["Pompes sur les genoux", "Pectoraux", "Poids de corps", "",
   "Appui sur les genoux, corps aligné des genoux aux épaules. La première marche.",
   ""],
  ["Pompes surélevées", "Pectoraux", "Poids de corps", "",
   "Pieds surélevés, davantage de charge sur les épaules et le haut des pectoraux.",
   ""],
  ["Dips sur barre droite", "Triceps", "Poids de corps", "",
   "Dips sur une barre unique, buste penché pour passer par-dessus. Prépare le muscle-up.",
   ""],
  ["Squat profond", "Jambes", "Poids de corps", "",
   "Descente complète, talons au sol, tenue en bas quelques secondes. Autant de mobilité que de force.",
   ""],
  ["Squats serrés", "Jambes", "Poids de corps", "",
   "Pieds joints ou presque : plus de quadriceps et de mobilité de cheville.",
   ""],
  ["Squats archer", "Jambes", "Poids de corps", "",
   "Poids sur une jambe, l'autre tendue sur le côté. Étape vers le squat pistolet.",
   ""],
  ["Squat pistolet assisté", "Jambes", "Poids de corps", "",
   "Une main sur un appui, ou contrepoids devant. Permet de travailler l'amplitude complète.",
   ""],
  ["Squat pistolet surélevé", "Jambes", "Poids de corps", "",
   "Debout sur une marche, la jambe libre descend dans le vide. Moins de mobilité demandée.",
   ""],
  ["Tuck L-sit", "Abdominaux", "Poids de corps", "",
   "En appui, genoux ramenés à la poitrine, bassin décollé. Première étape du L-sit.",
   ""],
  ["Relevé de genoux suspendu", "Abdominaux", "Poids de corps", "",
   "Suspendu à la barre, genoux vers la poitrine, sans balancier.",
   ""],
  ["Relevé de jambes au sol", "Abdominaux", "Poids de corps", "",
   "Allongé, mains sous les fessiers, jambes tendues qui descendent sans toucher le sol.",
   ""],
  ["Crunch croisé debout", "Abdominaux", "Poids de corps", "",
   "Debout, coude vers le genou opposé. Version accessible du crunch bicyclette.",
   ""],
  ["Pont en table", "Fessiers", "Poids de corps", "",
   "Assis, mains derrière, on monte le bassin jusqu'à l'horizontale. Ouvre les épaules et la hanche.",
   ""],
  ["Équilibre au mur", "Épaules", "Poids de corps", "",
   "Poirier face ou dos au mur, corps gainé. Tenu au chrono, la base avant les pompes en équilibre.",
   ""],
